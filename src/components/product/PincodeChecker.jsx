  ...
  return (
    <div className="rounded-2xl border border-border p-5">
      <div className="space-y-2.5">
        <div className="flex items-start gap-2.5 text-xs text-text/70">
          <HiOutlineTruck className="mt-0.5 shrink-0 text-gold" />
          {SHIPPING_POLICY.freeShipping}
        </div>
        <div className="flex items-start gap-2.5 text-xs text-text/70">
          <HiOutlineBanknotes className="mt-0.5 shrink-0 text-gold" />
